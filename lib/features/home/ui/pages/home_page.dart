...
class HomePage extends StatelessWidget {
  const HomePage({super.key, this.userInfoEntity});
...
class _HomePageState extends State<_HomePage> {
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  if (GetPlatform.isWeb)
                                    buildStackForWeb(context, constraints),
                                ],
                              ),
                            ).animate().fade(
  ...
  Stack buildStackForWeb(BuildContext context, BoxConstraints constraints) {
    return Stack(
      fit: StackFit.loose,
      alignment: Alignment.centerLeft,
      children: [
